...
let counter4 = parseFloat(document.querySelector(".calculate4").innerText);

function add4() {
  counter4 += 0.1;
  document.querySelector(".calculate4").innerText =
    Math.round(counter4 * 10) / 10;
  console.log(counter1);
  if (counter4 <= 17.2) {
    alert("goosebumps");
  }
...
function auction4() {
  let a = document.querySelector(".calculate4").innerText;
  ...
  document.querySelector(".display7").innerText = c;
  document.querySelector(".display8").innerText = d;

  buy4();
}

function buy4() {
  let user1Value = document.querySelector(".display7").innerText.split(": ")[1];
  let user2Value = document
    .querySelector(".display8")
    .innerText.split(" is ")[1];
  if (user1Value > user2Value) {
    alert("You are Not Eligible");
  } else {
